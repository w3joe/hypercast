...
export default function CompareView({ jobs, finalAction, offlineExamples = false }: { jobs: ComparisonJob[]; finalAction: (job: Job) => ReactNode; offlineExamples?: boolean }) {
